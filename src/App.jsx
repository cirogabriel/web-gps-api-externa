        ...
        <div className="flex items-center justify-between p-4 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Seguimiento premium</p>
            </div>
          </div>
        ...
        <div className="p-4 border-b border-border">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-muted/50 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-accent/50"
            />
          </div>
        </div>
        ...
        {location && (
          <div className="p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Card className="p-3 bg-card/30 border-border hover:bg-card/50 transition-colors cursor-pointer">
                <div className="text-center">
                  <Route className="w-5 h-5 text-accent mx-auto mb-1" />
                  <p className="text-xs font-medium">Rutas</p>
                </div>
              </Card>
              <Card className="p-3 bg-card/30 border-border hover:bg-card/50 transition-colors cursor-pointer">
                <div className="text-center">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="lg:hidden flex items-center justify-between p-4 bg-card border-b border-border">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sm">GPS Tracker</span>
          </div>
        ...
        <div className="hidden lg:flex items-center justify-between p-4 bg-card/50 border-b border-border">
        ...
        <div className="flex-1 relative bg-muted">
          ...
          <div className="absolute bottom-6 right-6 flex flex-col gap-2">
            <Button size="icon" className="bg-card/90 backdrop-blur-sm border border-border hover:bg-card">
